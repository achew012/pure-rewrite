...
class Document:
    def __init__(self, js):
        ...
        sentence_lengths = [len(entry["sentences"][0]) for entry in entries]
...
class Events:
    def __init__(self, events_json, text, sentence_start):
        self.event_list = [Event(this_event, text, sentence_start)
